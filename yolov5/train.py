...
def parse_opt(known=False):
    ...
    # opt['img'] = 450
    # opt['batch'] = 16
    # opt['data'] = '../data/2.v1i.yolov5pytorch/data.yaml'
    # opt['epochs'] = 100
    ...
    parser.add_argument('--data', type=str, default='../data/1.v1i.yolov5pytorch/data.yaml', help='dataset.yaml path')
    parser.add_argument('--hyp', type=str, default=ROOT / 'data/hyps/hyp.scratch.yaml', help='hyperparameters path')
    parser.add_argument('--epochs', type=int, default=200)
    parser.add_argument('--batch-size', type=int, default=16, help='total batch size for all GPUs, -1 for autobatch')
    parser.add_argument('--imgsz', '--img', '--img-size', type=int, default=450, help='train, val image size (pixels)')
