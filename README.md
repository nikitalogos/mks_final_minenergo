...
В этой работе также представлены другие алгоритмы компьютерного зрения, для решения кейсовых задач. Их методы и примеры 
...
фильтрации высокочастотного шума и выделению больших контуров с измерением длины в направлении угла на солнце.
